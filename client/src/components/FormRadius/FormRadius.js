...
import {setRadius, setRadiusAndSendOnServer} from '../../redux/actions/radiusActions'
        ...
        <div className={style.form}>
            ...
            <form onSubmit={handleSubmit} className={style.form}>
                ...
                <div className={style.rangeForm}>
                    ...
                    <input type="range" onChange={handleRadius} value={inputRadius} name="radius" className="form-range"
                           min="1" max="15" id="customRange2"/>
                    <br/>
                </div>

                <button className="btn btn-danger mx-4" type="submit">Отправить</button>
            </form>
        </div>
    )
}
